...
const ptBR = {
  ...
  pins: {
    ...
    styleTitle: "Estilo dos pontos",
    pointSettings: "Ponto",
    labelSettings: "Rótulo",
    showLabels: "Mostrar rótulos",
    labelField: "Campo do rótulo",
    noLabel: "Sem rótulo",
    scaleDuplicates: "Escalar duplicados",
    duplicateSuffix: "Sufixo de duplicados",
    allowOverlap: "Permitir sobreposição",
    radius: "Raio",
    maxScale: "Escala máxima",
    fontSize: "Tamanho do texto",
    labelGap: "Distância do rótulo",
    strokeWidth: "Largura do contorno",
    haloWidth: "Largura do halo",
    opacity: "Opacidade",
    fillColor: "Cor de preenchimento",
    strokeColor: "Cor do contorno",
    textColor: "Cor do texto",
    haloColor: "Cor do halo",
    position: "Posição do rótulo",
    positionAbove: "Acima",
  ...
  selection: {
    ...
    hintDetail: "para desenhar uma área. Depois, arraste as bordas ou o interior para ajustar e clique em Aceitar",
    center: "Centro",
    sw: "SW",
    ne: "NE",
    size: "Tamanho",
    ...
    accept: "Aceitar",
    revert: "Reverter",
    editHint: "Arraste as bordas para ajustar",
  },
  style: {
    sectionTitle: "Estilo",
    ...
    buildingsColor: "Cor dos edifícios",
...
const enUS = {
  ...
  pins: {
    ...
    styleTitle: "Point style",
    pointSettings: "Point",
    labelSettings: "Label",
    showLabels: "Show labels",
    labelField: "Label field",
    noLabel: "No label",
    scaleDuplicates: "Scale duplicate points",
    duplicateSuffix: "Append duplicate count",
    allowOverlap: "Allow label overlap",
    radius: "Base radius",
    maxScale: "Maximum duplicate scale",
    fontSize: "Font size",
    labelGap: "Point-to-label gap",
  ...
  selection: {
    ...
    hintDetail: "to draw an area. Then drag the edges or interior to adjust and click Accept",
    center: "Center",
    sw: "SW",
    ne: "NE",
    size: "Size",
    ...
    accept: "Accept",
    revert: "Revert",
    editHint: "Drag the edges to adjust",
  },
  style: {
    sectionTitle: "Style",
    mapStyle: "Map style",
    ...
    buildingsColor: "Buildings color",
